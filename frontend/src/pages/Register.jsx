            ...
            <div className="max-w-md w-full space-y-8 glass p-10 rounded-2xl">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Join the campus community to report or claim items
                    </p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={loading}
                            className="group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors shadow-md disabled:bg-primary-400"
                        >
