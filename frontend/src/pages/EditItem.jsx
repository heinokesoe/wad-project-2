...
const EditItem = ({ user }) => {
    ...
    if (initialLoading) return <div className="p-12 text-center animate-pulse">Loading item details...</div>;

    return (
        <div className="max-w-3xl mx-auto px-4 sm:px-6 w-full py-12">
            <Link to={`/items/${id}`} className="text-primary-600 hover:text-primary-700 font-medium mb-6 inline-block">&larr; Back to item</Link>
            ...
            <div className="glass p-8 md:p-10 rounded-2xl shadow-xl">
                <div className="mb-8 border-b border-gray-200 pb-5">
                    ...
                    <p className="text-gray-600 mt-2">Update the details of your lost or found item.</p>
                </div>
                            ...
                            {formData.imageUrl && (
                                <div className="mb-3 flex items-center gap-3">
                                    ...
                                    <div className="h-16 w-16 rounded-lg border border-gray-200 overflow-hidden bg-gray-50">
                                        <img src={formData.imageUrl.startsWith('http') ? formData.imageUrl : `${api.defaults.baseURL.replace('/api', '')}${formData.imageUrl}`} alt="Current" className="h-full w-full object-cover" />
                                    </div>
                                </div>
                            )}
